...
KERNEL_BOOTIMAGE_CMDLINE = console=ttyMSM0,115200n8 earlycon=msm_geni_serial,0xa90000 androidboot.hardware=qcom androidboot.console=ttyMSM0 androidboot.usbcontroller=a600000.dwc3 service_locator.enable=1 loop.max_part=7 androidboot.init_fatal_reboot_target=recovery kpti=off buildvariant=userdebug console=tty0 droidian.lvm.prefer
...
# Defconfig to use
KERNEL_DEFCONFIG = $(DEVICE_MODEL)_defconfig
